DROP DATABASE IF EXISTS Actividad3;
...
INSERT INTO pago VALUES (1,'PayPal','ak-std-000001','2008-11-10',2000),
						(3,'PayPal','ak-std-000002','2008-12-10',2000),
						(4,'PayPal','ak-std-000003','2009-01-16',5000),
						(5,'PayPal','ak-std-000004','2009-02-16',5000),
						(6,'PayPal','ak-std-000005','2009-02-19',926),
						(7,'PayPal','ak-std-000006','2007-01-08',20000),
						(8,'PayPal','ak-std-000007','2007-01-08',20000),
						(9,'PayPal','ak-std-000008','2007-01-08',20000),
						(10,'PayPal','ak-std-000009','2007-01-08',20000),
						(11,'PayPal','ak-std-000010','2007-01-08',1849),
						(12,'Transferencia','ak-std-000011','2006-01-18',23794),
						(13,'Cheque','ak-std-000012','2009-01-13',2390),
						(14,'PayPal','ak-std-000013','2009-01-06',929),
						(15,'PayPal','ak-std-000014','2008-08-04',2246),
						(16,'PayPal','ak-std-000015','2008-07-15',4160),
						(17,'PayPal','ak-std-000016','2009-01-15',2081),
						(18,'PayPal','ak-std-000035','2009-02-15',10000),
						(19,'PayPal','ak-std-000017','2009-02-16',4399),
						(20,'PayPal','ak-std-000018','2009-03-06',232),
						(21,'PayPal','ak-std-000019','2009-03-26',272),
						(22,'PayPal','ak-std-000020','2008-03-18',18846),
						(23,'PayPal','ak-std-000021','2009-02-08',10972),
						(24,'PayPal','ak-std-000022','2009-01-13',8489),
						(25,'PayPal','ak-std-000024','2009-01-16',7863),
						(26,'PayPal','ak-std-000025','2007-10-06',3321),
						(27,'PayPal','ak-std-000026','2006-05-26',1171);
...
select nombre_cliente from cliente where (ciudad = "madrid") and codigo_empleado_rep_ventas between 11 and 30;
